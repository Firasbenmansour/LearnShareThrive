<?php
$Directory = "."; // Directory where Mathematics.php is located
$Category = "Mathematics"; // Set the category explicitly
?>
...
<head>
    ...
    <title>Mathematics Courses</title>
    ...
    <div class="page">
        ...
        <div class="wrapper">
            ...
            <div class="card-container">
                <?php
                // Check if the Mathematics directory exists
                if (is_dir($Directory)) {
                    // Open the Mathematics directory
                    $courseFolders = scandir($Directory);

                    foreach ($courseFolders as $folder) {
                        // Skip the current and parent directory entries and the Mathematics.php file
                        if ($folder === '.' || $folder === '..' || $folder === 'Mathematics.php') {
                            continue;
                        }
                    ...
                    echo "<p>No courses found in the Mathematics directory.</p>";
                }
                ?>
            </div>
        </div>
