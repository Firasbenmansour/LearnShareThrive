<?php
$Directory = "."; // Directory where Physics.php is located
$Category = "Physics"; // Set the category explicitly
?>
    ...
    <div class="page">
        ...
        <div class="wrapper">
            ...
            <div class="card-container">
                <?php
                // Check if the physics directory exists
                if (is_dir($Directory)) {
                    // Open the physics directory
                    $courseFolders = scandir($Directory);

                    foreach ($courseFolders as $folder) {
                        // Skip the current and parent directory entries and the Physics.php file
                        if ($folder === '.' || $folder === '..' || $folder === 'physics.php') {
                            continue;
                        }
                    ...
                    echo "<p>No courses found in the physics directory.</p>";
                }
                ?>
            </div>
        </div>
