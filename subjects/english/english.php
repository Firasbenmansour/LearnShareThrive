<?php
$Directory = "."; // Directory where English.php is located
$Category = "English"; // Set the category explicitly
?>
    ...
    <div class="page">
        ...
        <div class="wrapper">
            ...
            <div class="card-container">
                ...
                if (is_dir($Directory)) {
                    // Open the English directory
                    $courseFolders = scandir($Directory);

                    foreach ($courseFolders as $folder) {
                        // Skip the current and parent directory entries and the English.php file
                        if ($folder === '.' || $folder === '..' || $folder === 'English.php') {
                            continue;
                        }
                    ...
                    echo "<p>No courses found in the English directory.</p>";
                }
                ?>
            </div>
        </div>
