<?php
$Directory = "."; // Directory where Philosophy.php is located
$Category = "Philosophy"; // Set the category explicitly
?>
...
<head>
    ...
    <title>Philosophy Courses</title>
...
<body>
    <div class="page">
        ...
        <div class="wrapper">
            <h1>Philosophy Courses</h1>
            <div class="card-container">
                <?php
                // Check if the Philosophy directory exists
                if (is_dir($Directory)) {
                    // Open the Philosophy directory
                    $courseFolders = scandir($Directory);

                    foreach ($courseFolders as $folder) {
                        // Skip the current and parent directory entries and the Philosophy.php file
                        if ($folder === '.' || $folder === '..' || $folder === 'Philosophy.php') {
                            continue;
                        }
                    ...
                    echo "<p>No courses found in the Philosophy directory.</p>";
                }
                ?>
            </div>
        </div>
