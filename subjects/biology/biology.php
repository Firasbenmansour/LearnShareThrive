<?php
$Directory = "."; // Directory where Biology.php is located
$Category = "Biology"; // Set the category explicitly
?>
...
<head>
    ...
    <title>Biology Courses</title>
    <link rel="stylesheet" href="/learnsharethrive/subjects/subjects.css">
...
<body>
    <div class="page">
        ...
        <div class="wrapper">
            <h1>Biology Courses</h1>
            <div class="card-container">
                <?php
                // Check if the Biology directory exists
                if (is_dir($Directory)) {
                    // Open the Biology directory
                    $courseFolders = scandir($Directory);

                    foreach ($courseFolders as $folder) {
                        // Skip the current and parent directory entries and the Biology.php file
                        if ($folder === '.' || $folder === '..' || $folder === 'Biology.php') {
                            continue;
                        }
                    ...
                    echo "<p>No courses found in the Biology directory.</p>";
                }
                ?>
            </div>
        </div>
